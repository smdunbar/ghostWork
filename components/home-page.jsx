...
export default function HomePage({ onNavigate }) {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <button onClick={() => onNavigate("experience")} className="border-5 border-emerald-400 rounded-lg p-8 mb-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer">
      <div className="flex">

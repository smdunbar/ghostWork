...
export default function HomePage({ onNavigate }) {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="border-5 border-emerald-400 rounded-lg p-8 mb-8 shadow-lg">
      <div className="flex">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="border-5 border-red-500 bg-neutral-900 rounded-lg p-6 shadow-lg">
          ...
          <button
              ...
              className="bg-red-500 text-neutral-950 px-10 py-2 rounded-full text-lg font-medium hover:bg-red-400 transition-colors"
            >
              <ArrowRight className="inline-block ml-2" />
            </button>
            </div>
        </div>
        <div className="border-5 border-amber-400 bg-neutral-900 rounded-xl p-6 shadow-lg">
          <div className="flex items-center gap-8 justify-evenly">
            <div className="w-72">
          ...
          <button
              ...
              className="bg-amber-400 text-neutral-950 px-10 py-2 rounded-full text-lg font-medium hover:bg-amber-300 transition-colors"
            >
              <ArrowRight className="inline-block ml-2" />
            </button>
            </div>
